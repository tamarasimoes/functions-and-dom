...
O DOM também define métodos e propriedades para acessar e atualizar cada objeto nesse modelo o que, por sua vez, atualiza aquilo que o usuário vê no navegador.
 ...
 ------------ | ----------------- | --------------- | ------------
 Acima, você pode ver o código HTML para uma lista de compras,  | Elementos HTML descrevem a estrutura de uma página HTML. OS elementos descrevem    | As tags de abertura dos elementos HTML podem conter atributos e esses são representados | Depois de ter acessado um nó de elemento, você pode então buscar o texto dentro desse elemento. |
